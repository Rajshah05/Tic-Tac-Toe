...
// Second test case is tested for single player games and computer (player 2) wins
// Third test case is tested for double player games and player 1 wins
// Fourth test case is tested for double player games and player 2 wins
...
TEST_CASE("tictactoe game is played against computer and computer wins and match draw", "[p2 wins][single player]") {
    game->reset();
    game->setGrid(3);
...
TEST_CASE("tictactoe game is played against human and player 1 wins, [double player]") {
    game->reset();
    game->setGrid(3);
...
TEST_CASE("tictactoe game is played against human and player 2 wins, [double player]") {
    game->reset();
    game->setGrid(3);
    REQUIRE(game->play() == "Player 2 wins!!!");
    game->reset();
